          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                height: 44,
                child: TextField(
                  onSubmitted: (value) => {_signinModel.email = value},
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                height: 44,
                child: TextField(
                  onSubmitted: (value) => {_signinModel.password = value},
            ...
            Padding(
              padding:
                  const EdgeInsets.only(top: 8.0, bottom: 8.0, right: 50.0),
              child: Align(
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  var isSuccess = await UserService().signIn(_signinModel);
                  if (isSuccess) {
                    Get.to(const ChooseMajor());
                  }
                },
                child: Text('Sign in',
                    style: AppFonts.medium(
